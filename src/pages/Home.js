        ...
        <section className="container">
          ...
          <section className="px-4 mt-10">
            <div className="flex flex-col md:flex-row md:space-x-10 md:items-center">
              <h1 className="text-[3em] py-2 uppercase font-semibold border-nblack border-t-2 border-b-2 md:text-left">
                Front-End Developer
                <br /> & UI Designer
              </h1>
              <img
          ...
          <section className="mt-24 px-4">
            ...
            <p className="font-thin text-xl">
              ...
              processus/chemin nécessaire pour concevoir des interfaces
              répondant aux besoins du projet et des utilisateurs. <br />
              <br />
