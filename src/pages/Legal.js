  ...
  return (
    <>
      <section className="container">
        <NavBar />
        <section className="mt-10 space-y-20 px-4">
          <h1 className="text-[3em] py-2 uppercase text-center font-semibold border-nblack border-t-2 border-b-2">
          ...
          <div>
            ...
            <p className="text-xl font-thin">
              ...
              utilisateurs du site alexisrouet.fr l’identité des différents
              intervenants dans le cadre de sa réalisation et de son suivi :
              Propriétaire : Alexis Rouet - 45 Traverse Marcel Pagnol 83300
              <br />
              Créateur : Alexis Rouet
              <br />
              Responsable publication : Alexis Rouet -
              alexis.design.ui@gmail.com Le responsable publication est une
              personne physique.
              <br /> Webmaster : Alexis Rouet - contact@alexisrouet.fr
              <br /> Hébergeur : o2switch – 222-224 Boulevard Gustave Flaubert,
              63000 Clermont-Ferrand
              <br /> Crédits : éléments visuels du site (images, iconographies)
              by Benjamin Sutter, Eberhard Grossgasteiger, Brady Knoll, Flo
              Maderebner, Tirachard Kumtamon, Jungsa, Kerismaker -
              www.flaticon.com - www.pexels.com
              <br /> Le modèle de mentions légales est offert par
              Subdelirium.com
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-xl font-thin">
              L’utilisation du site alexisrouet.fr implique l’acceptation pleine
              ...
              alexisrouet.fr sont donc invités à les consulter de manière
              régulière.
              <br /> Ce site est normalement accessible à tout moment aux
              utilisateurs. Une interruption pour raison de maintenance
              technique peut être toutefois décidée par Alexis Rouet , qui
              s’efforcera alors de communiquer préalablement aux utilisateurs
              les dates et heures de l’intervention.
              <br /> Le site alexisrouet.fr est mis à jour régulièrement par
              Alexis Rouet. De la même façon, les mentions légales peuvent être
          ...
          <div>
            ...
            <p className="text-xl font-thin">
              Le site alexisrouet.fr est un site présentant son portfolio et ses
              expériences. <br />
              Alexis Rouet s’efforce de fournir sur le site alexisrouet.fr des
              ...
              <br /> Tous les informations indiquées sur le site alexisrouet.fr
              sont données à titre indicatif, et sont susceptibles d’évoluer.
              Par ailleurs, les renseignements figurant sur le site
              alexisrouet.fr ne sont pas exhaustifs. Ils sont donnés sous
          ...
          <div>
            ...
            <p className="text-xl font-thin">
              ...
              <br /> Le site Internet ne pourra être tenu responsable de
          ...
          <div>
            ...
            <p className="text-xl font-thin">
              Alexis Rouet est propriétaire des droits de propriété
              ...
              autorisation écrite préalable de : Alexis Rouet.
          ...
          <div>
            ...
            <p className="text-xl font-thin">
              ...
              données. Le cas échéant, Alexis Rouet se réserve également la
          ...
          <div>
            ...
            <p className="text-xl font-thin">
              Responsable du traitement des données : Alexis Rouet,
              ...
              <br /> A l’occasion de l’utilisation du site alexisrouet.fr,
              peuvent êtres recueillies : l’URL des liens par l’intermédiaire
              desquels l’utilisateur a accédé au site alexisrouet.fr, le
              fournisseur d’accès de l’utilisateur, l’adresse de protocole
              Internet (IP) de l’utilisateur.
              <br /> Mais aussi via le formulaire de contact : nom, e-mail,
              objet et message.
              <br /> En tout état de cause Alexis Rouet ne collecte des
              informations personnelles relatives à l’utilisateur que pour le
              besoin de certains services proposés par le site alexisrouet.fr.
              ...
              est alors précisé à l’utilisateur du site alexisrouet.fr
              ...
              alexisrouet.fr n’est publiée à l’insu de l’utilisateur, échangée,
              transférée, cédée ou vendue sur un support quelconque à des tiers.
              Seule l’hypothèse du rachat de Alexis Rouet et de ses droits
              ...
              l’utilisateur du site alexisrouet.fr.
              <br /> Les bases de données sont protégées par les dispositions de
              ...
              <br /> Vous avez le droit de demander de consulter vos données, de
              les modifier ou les supprimer. Vous avez également le droit de
              retirer votre consentement à tout moment en faisant la demande par
              mail à l’adresse contact@alexisrouet.fr.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-xl font-thin">
              alexisrouet.fr est suseptible de recueillir et traiter les
              informations concernant votre visite sur le site avec Google
              Analytics, telles que les pages consultées, les recherches
              effectuées, le site Web visité juste avant celui-ci ou encore vos
              choix de service ou de personnalisation. Ces informations
              permettent d’améliorer le contenu du site.
              <br /> Google Analytics est un service d’analyse web proposé par
              Google qui assure le suivi du trafic d’un site web et en rend
              compte. Google utilise les données recueillies pour suivre et
              surveiller l’utilisation de notre Service. Ces données sont
              partagées avec d’autres services Google. Google peut utiliser les
              données recueillies pour contextualiser et personnaliser les
              annonces de son propre réseau publicitaire.
              <br />
              Vous pouvez empêcher que vos activités dans le cadre du Service ne
              soient mises à la disposition de Google Analytics en installant le
              plug-in pour navigateur Analytics Opt out browser add-on de Google
              Analytics. Ce plugin empêche le code JavaScript de Google
              Analytics JavaScript (ga.js, analytics.js et dc.js) de partager
              les informations concernant les activités liées aux visites avec
              Google Analytics. Pour plus de précisions sur les pratiques de
              confidentialité de Google, merci de consulter la page web
              Protection de la vie privée et conditions de Google.
              <br /> Le site alexisrouet.fr contient un certain nombre de liens
              hypertextes vers d’autres sites, mis en place avec l’autorisation
              de Alexis Rouet . Cependant, Alexis Rouet n’a pas la possibilité
              de vérifier le contenu des sites ainsi visités, et n’assumera en
              conséquence aucune responsabilité de ce fait.
              <br /> La navigation sur le site alexisrouet.fr est susceptible de
              ...
              l’installation des cookies :<br /> Sous Internet Explorer : onglet
              outil (pictogramme en forme de rouage en haut a droite) / options
              internet. Cliquez sur Confidentialité et choisissez Bloquer tous
              les cookies. Validez sur Ok.
              <br /> Sous Firefox : en haut de la fenêtre du navigateur, cliquez
              ...
              <br /> Sous Chrome : Cliquez en haut à droite du navigateur sur le
          ...
          <div>
            ...
            <p className="text-xl font-thin">
              Tout litige en relation avec l’utilisation du site alexisrouet.fr
          ...
          <div>
            <div className="flex items-center mb-5 mt-14">
              <div className="bg-nblack h-[2px] w-20 mr-4"></div>
              <h2 className="uppercase font-semibold text-[1.2em]">Lexique</h2>
            </div>
            <p className="text-xl font-thin">
              Utilisateur : Internaute se connectant, utilisant le site
              susnommé.
              <br /> Informations personnelles : « les informations qui
